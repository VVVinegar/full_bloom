    ...
    <div class="login-panel">
        ...
        <form>
            <div class="form-group">
                ...
                <input class="form-control login-input" id="nickname" placeholder="请输入用户名">
            </div>
            <div class="form-group">
...
<script>
    $(function () {
        ...
        // 记住登录信息
        function rememberLogin(nickname, password, checked) {
        ...
        function setLoginStatus() {
            ...
            if (loginStatusText) {
                ...
                try {
                    ...
                    $('#nickname').val(loginStatus.nickname)
...
//                        var fromPage = getFromPage(location.search.substr(1))
                        ...
                        // 记住登录信息
                        if(checked) {
                            rememberLogin(nickname, password)
                        } else {
